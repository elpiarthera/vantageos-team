...
import { ArrowRight, ClipboardList, Mail, Send, Settings } from "lucide-react";
...
const content = {
	...
	fr: {
		...
		subtitle:
			"Pas de recrutement. Pas de formation. Pas de drame d\u2019onboarding. Juste des r\u00e9sultats.",
...
export function TeamCta({ locale, onOpenIntake }: TeamCtaProps) {
		...
		<section className="py-16 md:py-24 bg-muted/30">
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
				...
				>
					<Button
						size="lg"
						className="min-h-touch text-base px-10 group"
					...
					<p className="mt-6 text-sm text-muted-foreground">
						{t.contact}{" "}
						<span className="text-foreground">laurent@perello.fr</span>
					</p>
