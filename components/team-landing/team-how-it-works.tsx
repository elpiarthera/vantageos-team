...
import { CheckCircle, Route, Send, TrendingUp } from "lucide-react";
...
const content = {
	...
	fr: {
		...
		subtitle:
			"Pas d'outil à apprendre. Pas de formation nécessaire. Quatre étapes, c'est tout.",
		steps: [
			{
				number: "01",
				icon: Send,
	...
	return (
		<section id="how-it-works" className="py-16 md:py-24">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="relative">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
						{t.steps.map((step, index) => (
							...
							>
								<div className="relative bg-card p-8 rounded-4xl shadow-md ring-1 ring-foreground/5 dark:ring-foreground/10 text-center">
									{/* Step number badge */}
				...
				{/* Emphasis */}
				<motion.div
					className="text-center mt-16 p-6 rounded-4xl bg-primary/5 ring-1 ring-primary/20 max-w-2xl mx-auto"
					initial={{ opacity: 0, y: 20 }}
					whileInView={{ opacity: 1, y: 0 }}
					viewport={{ once: true }}
