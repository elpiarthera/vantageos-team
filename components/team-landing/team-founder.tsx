...
const content = {
	...
	fr: {
		...
		xHandle: "@PerelloLaurent",
		highlight:
			"L\u2019humain dans la boucle n\u2019est pas une fonctionnalit\u00e9. C\u2019est le principe fondamental.",
	},
};
	...
	return (
		<section id="founder" className="py-16 md:py-24">
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					<div className="bg-card rounded-4xl p-8 md:p-10 shadow-md ring-1 ring-foreground/5 dark:ring-foreground/10">
					...
					<motion.div
						className="text-center p-6 rounded-4xl bg-primary/5 ring-1 ring-primary/20"
						initial={{ opacity: 0, y: 20 }}
						whileInView={{ opacity: 1, y: 0 }}
						viewport={{ once: true }}
