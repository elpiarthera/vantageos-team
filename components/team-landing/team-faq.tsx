...
const faqs: Record<Locale, FaqItem[]> = {
  en: [
    ...
    { category: 'General', question: 'What exactly is VantageOS Team?', answer: 'A fully managed AI team service. You get access to 16 specialized departments (marketing, sales, dev, content, SEO, etc.) with 79 AI agents and 160 skills, all supervised by Laurent Perello.' },
  ...
  fr: [
    ...
    { category: 'Général', question: 'Qu\'est-ce que VantageOS Team exactement ?', answer: 'Un service d\'équipe IA entièrement géré. Vous accédez à 16 départements spécialisés (marketing, vente, dev, contenu, SEO, etc.) avec 79 agents IA et 160 compétences, le tout supervisé par Laurent Perello.' },
