		...
		benefits: [
			{
				...
				description:
					"Delegate everything that does not generate revenue. Focus on what matters.",
				color: "text-chart-1",
			...
			},
			{
				...
				description:
					"Send tasks by email or Telegram. No platform. No login. No training.",
				color: "text-chart-2",
			...
			},
			{
				...
				description:
					"A dedicated knowledge base that makes results better month after month.",
				color: "text-chart-4",
			...
			},
			{
				...
				description:
					"No commitment. No notice period. No penalty. Stop when you want.",
				color: "text-chart-5",
		...
		benefits: [
			{
				...
				description:
					"Déléguez tout ce qui ne génère pas de revenu. Concentrez-vous sur l'essentiel.",
				color: "text-chart-1",
				bgColor: "bg-chart-1/10",
			},
			{
				...
				description:
					"Envoyez vos tâches par email ou Telegram. Pas de plateforme. Pas de login. Pas de formation.",
				color: "text-chart-2",
				bgColor: "bg-chart-2/10",
			},
			{
				...
				description:
					"Une base de connaissances dédiée qui améliore les résultats mois après mois.",
				color: "text-chart-4",
				bgColor: "bg-chart-4/10",
			},
			{
				...
				description:
					"Sans engagement. Sans préavis. Sans pénalité. Arrêtez quand vous voulez.",
				color: "text-chart-5",
				bgColor: "bg-chart-5/10",
			},
		],
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-lg text-muted-foreground">
						{t.subtitle(teamsVal, agentsVal, skillsVal)}
					</p>
				</motion.div>
