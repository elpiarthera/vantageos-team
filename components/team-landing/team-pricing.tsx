...
const paceDescriptions = {
	...
	fr: {
		...
		"40h":
			"Semaine complète, file prioritaire, livraison garantie le jour même",
	},
};
...
const plans: Record<Locale, Plan[]> = {
	en: [
		...
		},
		{
			...
			setupFee: 790,
			setupIncludes:
				"Intake call (60 min), brand/voice capture, full knowledge base",
			popular: true,
			commitment: true,
		},
		{
			...
			setupFee: 1490,
			setupIncludes:
				"Deep onboarding, per-team process docs, custom agent instructions",
		},
		{
			name: "Empire",
			teams: "All 16 teams",
			...
			setupFee: 2490,
			setupIncludes:
				"Full operations audit, integration with existing tools, strategy docs",
		},
		{
			name: "Solo Dev",
			...
			setupFee: 490,
			setupIncludes:
				"Technical intake, repo access setup, dev workflow calibration",
			premium: true,
			commitment: true,
		},
	],
	fr: [
		{
			...
			setupFee: 490,
			setupIncludes:
				"Formulaire d'intégration, connexion des outils, calibration première semaine",
			commitment: true,
		},
		{
			name: "Studio",
			...
			setupFee: 790,
			setupIncludes:
				"Appel d'intégration (60 min), capture de voix/marque, base de connaissances complète",
			popular: true,
			commitment: true,
		},
		{
			...
			setupFee: 1490,
			setupIncludes:
				"Intégration approfondie, documentation de processus par équipe, instructions personnalisées",
		},
		{
			name: "Empire",
			...
			setupFee: 2490,
			setupIncludes:
				"Audit complet de vos opérations, intégration avec vos outils existants, documents stratégiques",
		},
		{
			name: "Solo Dev",
...
const content = {
	en: {
		...
		subtitle:
			"You select the teams you need. You choose the weekly hours. That is it.",
		perMonth: "/mo",
		...
		noCommitment:
			"No commitment. Cancel anytime. No payroll taxes. Month-to-month.",
	...
	fr: {
		...
		subtitle:
			"Vous sélectionnez les équipes dont vous avez besoin. Vous choisissez le volume horaire. C'est tout.",
		perMonth: "/mois",
		setupLabel: "Frais de mise en place",
		setupWaived: "Offerts pour les clients fondateurs",
		extraTeam:
			"Besoin d'une équipe en dehors de votre formule ? 190 EUR/mois par équipe supplémentaire.",
		noCommitment:
			"Sans engagement. Résiliable à tout moment. Pas de charges sociales. Mois par mois.",
...
export function TeamPricing({ locale, onOpenIntake }: TeamPricingProps) {
