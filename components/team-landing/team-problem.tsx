...
import { Banknote, Clock, HeadphonesIcon, Puzzle } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import type { Locale } from "./team-landing-page";

const content = {
	en: {
		title: "You run everything alone.",
		...
		problems: [
			{
				...
				description:
					"Follow-ups, emails, reporting, formatting -- tasks that never end.",
			},
			{
				icon: Banknote,
				title: "Hiring is expensive",
				description:
					"EUR 28,000-42,000/year for a junior. Plus training, management, holidays.",
			},
			{
				icon: Puzzle,
				title: "AI tools are complex",
				description:
					"You tried ChatGPT. You gave up after two weeks. Too many prompts, no consistency.",
			},
			{
				icon: HeadphonesIcon,
				title: "You want someone to handle it",
				description:
					"Not another tool. Not another login. Someone who just does the work.",
			},
		],
		closing:
			"You do not need a better tool. You need a team that works without you.",
	},
	fr: {
		title: "Vous g\u00e9rez tout seul.",
		titleAccent: "On prend le relais.",
		subtitle:
		...
		problems: [
			{
				...
				description:
					"Relances, emails, reporting, mise en forme -- des tâches sans fin.",
			},
			{
				icon: Banknote,
				title: "Embaucher coûte cher",
				description:
					"28 000 à 42 000 EUR/an pour un junior. Plus la formation, le management, les congés.",
			},
			{
				icon: Puzzle,
				title: "Les outils IA sont complexes",
				description:
					"Vous avez essayé ChatGPT. Vous avez abandonné au bout de deux semaines. Trop de prompts, aucune cohérence.",
			},
			{
				icon: HeadphonesIcon,
				title: "Vous voulez quelqu'un qui s'en occupe",
				description:
					"Pas un outil de plus. Pas un login de plus. Quelqu'un qui fait le travail.",
			},
		],
		closing:
			"Vous n\u2019avez pas besoin d\u2019un meilleur outil. Vous avez besoin d\u2019une \u00e9quipe qui tourne sans vous.",
	},
};
